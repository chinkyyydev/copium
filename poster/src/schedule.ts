...
export const SLOTS: Slot[] = [
  { id: 'h00', hour: 0, label: 'midnight gremlin', categories: ['meta', 'internet', 'optimism'] },
  { id: 'h02', hour: 2, label: '2am gremlin', categories: ['meta', 'optimism', 'gaming'] },
  { id: 'h04', hour: 4, label: '4am void', categories: ['internet', 'optimism', 'meta'] },
  { id: 'h06', hour: 6, label: 'early rise', categories: ['sincere', 'optimism', 'internet'] },
  { id: 'h08', hour: 8, label: 'gm ritual', categories: ['optimism', 'internet', 'sincere'] },
  { id: 'h10', hour: 10, label: 'mid-morning', categories: ['ai', 'programming', 'startup'] },
  { id: 'h12', hour: 12, label: 'main joke of the day', categories: ['ai', 'programming', 'crypto', 'gaming'] },
  { id: 'h14', hour: 14, label: 'early afternoon', categories: ['startup', 'crypto', 'internet'] },
  { id: 'h16', hour: 16, label: 'afternoon reactive', categories: ['reaction', 'internet', 'meta'] },
  { id: 'h18', hour: 18, label: 'evening series', categories: ['gaming', 'anime', 'motivation'] },
  { id: 'h20', hour: 20, label: 'prime evening', categories: ['anime', 'motivation', 'advice'] },
  { id: 'h22', hour: 22, label: 'late night', categories: ['meta', 'internet', 'gaming'] },
];
